...
public class SafeAreaInputAccessoryViewWrapperView: UIView {
  ...
  public init(for view: UIView, color: UIColor) {
    ...
    defer {
      ...
      addedConstraints =
        [view.leadingAnchor.constraint(equalTo: leadingAnchor, constant: LayoutGuide.Margine.defaultLeading),
         view.trailingAnchor.constraint(equalTo: trailingAnchor, constant: LayoutGuide.Margine.defaultTrailing),
         view.topAnchor.constraint(equalTo: topAnchor, constant: LayoutGuide.Margine.defaultTop),
         view.bottomAnchor.constraint(equalTo: bottomAnchor, constant: LayoutGuide.Margine.defaultBottom),
         view.heightAnchor.constraint(equalToConstant: LayoutGuide.Height.primaryControl)]
    }
  }
